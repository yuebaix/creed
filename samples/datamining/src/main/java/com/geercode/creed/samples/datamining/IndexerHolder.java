...
/**
 * <p>Description : 索引器</p>
 * <p>Created on  : 2018-09-29 13:05</p>
 *
 * @author jerryniu
 * @since 1.0.0
 */
public class IndexerHolder {
    private static final IndexerHolder HOLDER = new IndexerHolder();

    private IndexerHolder() {
    }

    public static IndexerHolder getHolder() {
        return HOLDER;
    }

    /******创建索引********/

    public void luceneIndexing(String indexPath, String docsPath, boolean create) {
    ...
    @SneakyThrows
    public void luceneSearch(String indexPath) {
