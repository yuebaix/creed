...
import com.geercode.creed.service.VGoodService;
import com.geercode.creed.repo.dao.entity.VGoodEntity;
import com.geercode.creed.web.common.BaseResp;
 ...
 * @since 2019-05-09
 */
@Api(tags = "VGoodController")
@RestController
@RequestMapping("/VGoodController")
public class VGoodController {
    @Autowired
    private VGoodService targetService;
    ...
    public BaseResp findAll() {
        List<VGoodEntity> models = targetService.list(null);
    ...
    public BaseResp find(Long id) {
        VGoodEntity entity = targetService.getById(id);
        if (entity == null) {
    ...
    public BaseResp addItem(@RequestBody VGoodEntity entity) {
    ...
    public BaseResp updateItem(@RequestBody VGoodEntity entity) {
