 ...
 * @since 2018-09-18
 */
@Api(tags = "TProxyController")
@RestController
@RequestMapping("/tProxyEntity")
public class TProxyController {
    @Autowired
    private TProxyService targetService;
    ...
    public BaseResp findAll() {
        List<TProxyEntity> models = targetService.list(null);
    ...
    public BaseResp find(Long id) {
        TProxyEntity entity = targetService.getById(id);
        if (entity == null) {
