 ...
 */
@RestController
@RequestMapping("${symbol_dollar}{server.error.path:${symbol_dollar}{error.path:/error}}")
    ...
    public String error(HttpServletRequest request) {
        if (SystemConstant.PROFILE_DEV.equals(activeProfile)) {
            ...
            try {
                ...
                ex.printStackTrace();
                return "{${symbol_escape}"error${symbol_escape}" : ${symbol_escape}"jackson error${symbol_escape}"}";
            }
        }
        return "";
    }
